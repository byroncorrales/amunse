...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Archivo.adjunto'
        db.alter_column('documentos_archivo', 'adjunto', self.gf('django.db.models.fields.files.FileField')(max_length=100))


    models = {
        'documentos.archivo': {
            'Meta': {'object_name': 'Archivo'},
            'adjunto': ('documentos.customfilefield.ContentTypeRestrictedFileField', [], {'max_length': '100'}),
