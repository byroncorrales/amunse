...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('documentos_archivo', 'tags', self.gf('tagging_autocomplete.models.TagAutocompleteField')(max_length=255))

        # Changing field 'Archivo.adjunto'
        db.alter_column('documentos_archivo', 'adjunto', self.gf('amunse.documentos.customfilefield.ContentTypeRestrictedFileField')(max_length=100))

        # Changing field 'Archivo.slug'
        db.alter_column('documentos_archivo', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Archivo.adjunto'
        db.alter_column('documentos_archivo', 'adjunto', self.gf('documentos.customfilefield.ContentTypeRestrictedFileField')(max_length=100))

        # Changing field 'Archivo.slug'
        db.alter_column('documentos_archivo', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=25, unique=True))
