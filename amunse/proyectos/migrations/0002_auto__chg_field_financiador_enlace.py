...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Financiador.enlace'
        db.alter_column('proyectos_financiador', 'enlace', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Financiador.enlace'
        db.alter_column('proyectos_financiador', 'enlace', self.gf('django.db.models.fields.URLField')(max_length=200))
