...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Noticia.slug'
        db.alter_column('noticias_noticia', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=120))


    def backwards(self, orm):
        
        # Changing field 'Noticia.slug'
        db.alter_column('noticias_noticia', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
